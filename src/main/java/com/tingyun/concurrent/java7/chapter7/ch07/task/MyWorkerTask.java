package com.tingyun.concurrent.java7.chapter7.ch07.task;
import java.util.Date;
import java.util.concurrent.ForkJoinTask;

/**
 * This class extends the ForkJoinTask class to
 * implement your own version of a task running
 * in a ForkJoinPool of the Frok/Join framework.
 * It's equivalent to the RecursiveAction and
 * Recursive classes.
 * As the RecursiveAction class, it doesn't return any result
 *
 */
