package com.tingyun.concurrent.java7.chapter7.ch04.task;
...
public class MyThread extends Thread {
	 ...
	 * It establishes the value of the creation date attribute
	 ...
	 * Stores the start and finish date of the thread and calls
