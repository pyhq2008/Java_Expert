...
/**
 * 
 * This class implements an scheduled task to be execute in a scheduled thread pool executor.
 * It's
...
public class MyScheduledTask<V> extends FutureTask<V> implements RunnableScheduledFuture<V> {
	...
	/**
	 * Method to compare two tasks.
	 * It calls the compareTo() method of the original task
	 */
	@Override
	...
	/**
	 * Method that returns if the task is periodic or not.
	 * It calls the isPeriodic() method
