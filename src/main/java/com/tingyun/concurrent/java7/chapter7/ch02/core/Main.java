package com.tingyun.concurrent.java7.chapter7.ch02.core;

import com.tingyun.concurrent.java7.chapter7.ch02.task.MyPriorityTask;
 ...
 * It creates an Executor with a PriorityQueue as working queue and then
 * sends various tasks with different priorities to check
