package com.tingyun.concurrent.java7.chapter7.ch08.task;
...
/**
 * This class implements a basic Lock.
 * It uses a myAbstractQueueSyncrhonized object
...
public class MyLock implements Lock{
	...
	/**
	 * Method that try to acquire the lock.
	 * If it can't, the thread will
	 * be blocked until the thread that has it release the lock.
	 * The difference
	...
	/**
	 * Method that try to acquire the lock.
	 * If it can, the method returns the true
	...
	/**
	 * Method that try to acquire the lock.
	 * If it can, the method returns the true value.
	 * If it can't, wait the time specified as parameter
	 * and if the lock hasn't been
	 * released, it returns the false value.
	 * It the lock is released in that period of time,
