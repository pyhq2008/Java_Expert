package com.tingyun.concurrent.java7.chapter7.ch01.executor;
...
public class MyExecutor extends ThreadPoolExecutor {
	 ...
	 * When a task finish, it calculates the difference between the start date and the end date
	...
	/**
	 * This method is executed before the execution of a task.
	 * We store the start date in the HashMap
	 */
	@Override
	...
	/**
	 * This method is executed after the execution of a task.
	 * We calculate the execution time of the task
	 */
	@Override
