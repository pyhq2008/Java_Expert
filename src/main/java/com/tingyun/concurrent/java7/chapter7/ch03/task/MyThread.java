package com.tingyun.concurrent.java7.chapter7.ch03.task;
...
public class MyThread extends Thread {
	 ...
	 * Use the constructor of the Thread class and storeas the creation date of the Thread
	 ...
	 * and the finish date and calls the run() method of the parent class
	 */
	@Override
	public void run() {
		setStartDate();
